...
Version: 1.0.0
Author: Scientific Notation Calculator / www.calculator.io
...
function display_calcio_ci_scientific_notation_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_scientific_notation_calculator', 'display_calcio_ci_scientific_notation_calculator' );